...
On etend AbstractUser pour ajouter code_livreur et un role explicite.
Decision prise des le depart pour eviter une migration douloureuse plus tard.
"""
