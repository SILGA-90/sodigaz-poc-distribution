/**
 * En-tête navy de l'écran de saisie : statut GPS, type d'opération,
 * code PLV et raison sociale du client.
 */
...
const styles = StyleSheet.create({
  ...
  typeChip:     { paddingHorizontal: 9, paddingVertical: 3, borderRadius: 20, borderWidth: 1 },
  ...
  plvCodeChip:  { backgroundColor: 'rgba(7,155,217,0.25)', borderRadius: 6, paddingHorizontal: 7, paddingVertical: 2, borderWidth: 1, borderColor: 'rgba(7,155,217,0.5)' },
